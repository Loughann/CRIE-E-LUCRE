...
export default function VendaPage() {
  ...
  useEffect(() => {
    ...
    // Mobile-specific: detect when user scrolls up quickly (back gesture intent)
  ...
  const handleExitPopupTest = () => {
    ...
    // Set flag to indicate user came from exit popup
  ...
  const handleStartSimulation = () => {
    // Set a flag in sessionStorage to indicate user has seen the sales page
    sessionStorage.setItem("fromVenda", "true")
    router.push("/usuario")
  }
    ...
    <div className="min-h-screen bg-black text-white" ref={topRef}>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-6 bg-gray-800/50 rounded-lg p-3 border border-green-500/20">
              <p className="text-sm text-gray-300 flex items-center">
                ...
                <span>
                  <span className="text-yellow-400 font-bold">Apenas {remainingSpots} vagas</span> restantes para o
                  teste gratuito hoje
                </span>
              </p>
            </div>
      ...
      <section className="py-12 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Testimonial 1 */}
            <Card className="bg-gray-800 border-green-500/30 p-6 rounded-xl shadow-lg hover:shadow-green-500/10 transition-all">
              ...
              <div className="mt-3 text-xs text-gray-400">
                <span className="flex items-center">
                  <ThumbsUp className="h-3 w-3 mr-1 text-green-500" /> Verificado em 12/05/2024
                </span>
              </div>
            </Card>
            ...
            <Card className="bg-gray-800 border-green-500/30 p-6 rounded-xl shadow-lg hover:shadow-green-500/10 transition-all">
              ...
              <div className="mt-3 text-xs text-gray-400">
                <span className="flex items-center">
                  <ThumbsUp className="h-3 w-3 mr-1 text-green-500" /> Verificado em 08/05/2024
                </span>
              </div>
            </Card>
            ...
            <Card className="bg-gray-800 border-green-500/30 p-6 rounded-xl shadow-lg hover:shadow-green-500/10 transition-all">
              ...
              <div className="mt-3 text-xs text-gray-400">
                <span className="flex items-center">
                  <ThumbsUp className="h-3 w-3 mr-1 text-green-500" /> Verificado em 15/05/2024
                </span>
              </div>
            </Card>
          </div>
      ...
      <section className="py-12 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Step 1 */}
            <Card className="bg-gray-800 border-green-500/30 p-6 rounded-xl shadow-lg relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-green-900/20 to-green-700/20 border border-green-500/30 rounded-xl p-6 mb-8">
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">GARANTIA INCONDICIONAL DE 30 DIAS</h3>
                  <p className="text-gray-300">
                    Se você não começar a lucrar com IA nos primeiros 30 dias ou não ficar 100% satisfeito com o método,
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Accordion type="single" collapsible className="mb-8">
              <AccordionItem value="item-1" className="border-green-500/30 mb-3 bg-gray-800 rounded-xl overflow-hidden">
                <AccordionTrigger className="text-left font-bold px-4 py-3 hover:bg-gray-700/50">
              ...
              <AccordionItem value="item-5" className="border-green-500/30 mb-3 bg-gray-800 rounded-xl overflow-hidden">
                ...
                <AccordionContent className="text-gray-300 px-4 pb-4">
                  Oferecemos garantia incondicional de 30 dias. Se você seguir o método e não obtiver resultados, ou
      ...
      <footer className="py-8 bg-black border-t border-green-500/30">
        <div className="container mx-auto px-4 text-center text-gray-500 text-sm">
          <p>© 2024 Crie e Lucre com IA. Todos os direitos reservados.</p>
          <p className="mt-2">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-sm border-t border-green-500/30 p-4 z-40">
        ...
        <p className="text-center text-xs text-gray-400 mt-2">Restam apenas {remainingSpots} vagas hoje</p>
      </div>
